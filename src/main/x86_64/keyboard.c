...
static const char scancode_to_ascii_table[128] = {
    0, KEY_ESCAPE, '1', '2', '3', '4', '5',
    '6', // 0x00-0x07
    '7', '8', '9', '0', 's', '\'', KEY_BACKSPACE,
    KEY_TAB, // 0x08-0x0F
    'q', 'w', 'e', 'r', 't', 'z', 'u',
    'i', // 0x10-0x17
    'o', 'p', 'u', '+', KEY_ENTER, 0, 'a',
...
void keyboard_wait_for_key(void) { keyboard_get_char(); }

keyboard_status_t keyboard_get_status(void) { return keyboard_status; }
