...
x86_64_c++_src_files := $(shell find src/main/x86_64 -name *.cpp)
x86_64_c++_obj_files := $(patsubst src/main/x86_64/%.cpp, build/x86_64/%.o, $(x86_64_c++_src_files))
...
build-x86_64: $(kernel_obj_files) $(x86_64_c_obj_files) $(x86_64_c++_obj_files) $(x86_64_asm_obj_files)
	mkdir -p dist/x86_64
	x86_64-elf-ld -n -o dist/x86_64/kernel.bin -T targets/x86_64/linker.ld $(kernel_obj_files) $(x86_64_c_obj_files) $(x86_64_c++_obj_files) $(x86_64_asm_obj_files)
